...
class RoverState():
    def __init__(self):
        ...
        self.the_rock = 0 # If Rover can see the sample, store it's position here
        ...
        self.steer_hist = np.zeros(31, dtype=np.int) # The last steering angle history
        self.prev_angles_to_sample = None
        ...
        self.stuck_control = np.zeros((200,200), dtype=np.int)
        # Worldmap
        # Update this image with the positions of navigable terrain
        # obstacles and rock samples
        self.worldmap = np.zeros((200, 200, 3), dtype=np.float) 
        # Contains world positions of the visited areas
        self.visited_map = np.zeros((200, 200, 3), dtype=np.float) 
